Properties {
    ...
    ### Project information
	$solution = "Wrekt.SteamApi.Client.sln"
...
Task CreateNuGetPackage -Depends Compile {
	...
	copy-item $src_directory\Wrekt.SteamApi.Client\Wrekt.SteamApi.Client.nuspec $dist_directory
	exec { . $nuget pack $dist_directory\Wrekt.SteamApi.Client.nuspec -BasePath $dist_directory -o $dist_directory -version $packageVersion }
}
